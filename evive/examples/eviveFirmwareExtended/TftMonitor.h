...
class TftMonitor{
	private: 
		...
		double d;							//double to be printed
		float f;							//float to be printed
		int lines;						//????
	public:
	...
	private:
		//TFT_ST7735 tft;
		int8_t next_line;				//keep a track of the next line on tft.
		int8_t next_col;				//keep a track of the next column on tft.
